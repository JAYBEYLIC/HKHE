...
<section>
   ...
   <div class="container">
               ...
               <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab2">
                     <div class="row m-t-30">
                        ...
                        <div class="col-sm-9">
                           <h4 class="m-b-20"> JOYCE MEYER </h4>
                           <p>
      ...
      <div class="container course_study_det">
         <div class="row">
            <div class="col-sm-12">
               ...
               <p>
                  Cras feugiat sodales arcu. Sed id luctus purus. Aenean teristique risus id sem sollicution elementum. Class aptent taciti sociosqu ad litora torquent per conubia nostra,
                  <br />
      ...
      <div class="container course_study_det">
         <div class="row">
            <div class="col-sm-12">
               <h2 class="p-t-50"> Cras feugiat sodales arcu </h2>
               <hr class="tital_border m-l-0">
               <p>
                  Cras feugiat sodales arcu. Sed id luctus purus. Aenean teristique risus id sem sollicution elementum. Class aptent taciti sociosqu ad litora torquent per conubia nostra,
                  <br />
